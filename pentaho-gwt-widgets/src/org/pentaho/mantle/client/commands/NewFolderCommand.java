...
*/
  ...
  protected void performOperation( boolean feedback ) {
    ...
    final IDialogCallback callback = new IDialogCallback() {
      ...
      public void okPressed() {
        ...
        final String solutionPath = parentFolder.getPath() + "/" + URL.encodePathSegment( folderNameTextBox.getText() );

        String createDirUrl = getFullyQualifiedURL() + "api/repo/dirs/" + pathToId( solutionPath ); //$NON-NLS-1$
  ...
  //TODO Andrey_Burikhin - move to util class. -> this code was copied from SolutionBrowserPanel to exclude it from dependencies.
